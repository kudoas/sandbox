...
func (ec *executionContext) field_Mutation_addProjectV2ItemById_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNAddProjectV2ItemByIdInput2githubᚗcomᚋkudoasᚋgraphqlᚑsampleᚋgraphᚋmodelᚐAddProjectV2ItemByIDInput(ctx, tmp)
	}
...
func (ec *executionContext) unmarshalNAddProjectV2ItemByIdInput2githubᚗcomᚋkudoasᚋgraphqlᚑsampleᚋgraphᚋmodelᚐAddProjectV2ItemByIDInput(ctx context.Context, v any) (model.AddProjectV2ItemByIDInput, error) {
